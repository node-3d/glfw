...
#define JS_GLFW_CONSTANT(name) exports.Set(#name, static_cast<double>(GLFW_##name));

#define JS_GLFW_SET_METHOD(name)                                                                             \
	exports.DefineProperty(Napi::PropertyDescriptor::Function(env, exports, #name, glfw::name));
...
Napi::Object initModule(Napi::Env env, Napi::Object exports) {
	...
	JS_GLFW_SET_METHOD(testHeadlessFbo);
	JS_GLFW_SET_METHOD(testHeadlessFboMode);
	JS_GLFW_SET_METHOD(testSurfacelessEgl);
